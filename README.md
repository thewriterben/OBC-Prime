...
> and hash-checked, and CI builds and tests them: **1178 tests**.
>
...
```bash
cargo test --workspace     # 1178 tests
...
That matters because "1178 tests pass" and "you can see it refuse" are different
