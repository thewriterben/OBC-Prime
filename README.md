...
> and hash-checked, and CI builds and tests them: **1211 tests**.
>
...
```bash
cargo test --workspace     # 1211 tests
...
That matters because "1211 tests pass" and "you can see it refuse" are different
