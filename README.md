...
> and hash-checked, and CI builds and tests them: **1199 tests**.
>
...
```bash
cargo test --workspace     # 1199 tests
...
That matters because "1199 tests pass" and "you can see it refuse" are different
