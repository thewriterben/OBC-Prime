...
> and hash-checked, and CI builds and tests them: **1207 tests**.
>
...
```bash
cargo test --workspace     # 1207 tests
...
That matters because "1207 tests pass" and "you can see it refuse" are different
