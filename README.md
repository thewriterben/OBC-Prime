...
> and hash-checked, and CI builds and tests them: **1181 tests**.
>
...
```bash
cargo test --workspace     # 1181 tests
...
That matters because "1181 tests pass" and "you can see it refuse" are different
