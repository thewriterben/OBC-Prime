...
> and hash-checked, and CI builds and tests them: **1221 tests**.
>
...
```bash
cargo test --workspace     # 1221 tests
...
That matters because "1221 tests pass" and "you can see it refuse" are different
