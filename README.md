...
> and hash-checked, and CI builds and tests them: **1165 tests**.
>
...
```bash
cargo test --workspace     # 1165 tests
...
That matters because "1165 tests pass" and "you can see it refuse" are different
