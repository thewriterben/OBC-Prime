...
> and hash-checked, and CI builds and tests them: **1206 tests**.
>
...
```bash
cargo test --workspace     # 1206 tests
...
That matters because "1206 tests pass" and "you can see it refuse" are different
